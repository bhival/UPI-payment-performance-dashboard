...
│
├── 📁 sql/
│   ├── phase_a_operational_baseline.sql   # Questions 1–4
│   ├── phase_b_temporal_analysis.sql      # Questions 5–7
│   ├── phase_c_advanced_insights.sql      # Questions 8–10
│   └── all_queries_combined.sql           # All 10 queries in one file
│
├── 📁 tableau/
...
SOURCE sql/all_queries_combined.sql;
```
...
The dataset is fully synthetic and contains no real user data.
